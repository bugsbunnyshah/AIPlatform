...
class ProjectStore with ChangeNotifier {
  ...
  List<Project> get _allEmails => [
        ..._inbox,
        ..._outbox,
        ..._drafts,
      ];

  List<Project> get inboxEmails {
