...
class BraineousApp extends StatefulWidget {
  const BraineousApp({Key key}) : super(key: key);
  ...
  @override
  _BraineousAppState createState() => _BraineousAppState();
}

class _BraineousAppState extends State<BraineousApp> with RestorationMixin {
