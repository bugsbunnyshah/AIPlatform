...
public class SchemaStoreClient
{
	...
	/** Constructor for the Schema Store Client */
	public SchemaStoreClient(org.mitre.schemastore.client.Repository repository) throws RemoteException
	{
		try {			
			// Connects to a database or web service
			if(!repository.getType().equals(org.mitre.schemastore.client.Repository.SERVICE))
			{
