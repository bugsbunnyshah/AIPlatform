...
public class XMIWriter {	
	public static void write(org.mitre.schemastore.porters.projectExporters.xmi.XMIModel xmimodel, File f) throws Exception {
	...
	public static void main(String [] args) throws Exception { 
		org.mitre.schemastore.porters.projectExporters.xmi.XMIModel m = XMIModel.generateSimple();
