 ...
 * @author DMALLEN
 */
public class XMIModelElement extends org.mitre.schemastore.porters.projectExporters.xmi.XMIExportable {
	String name;
	String id; 	
	String type;	
	...
	public XMIModelElement() { 
		this(org.mitre.schemastore.porters.projectExporters.xmi.XMIModel.randomName());
	}
	...
	/**
	 * @see org.mitre.schemastore.porters.projectExporters.xmi.XMIExportable#renderAsXML(Document)
	 */
	...
	/**
	 * @see XMIExportable#renderExtensionXML(org.mitre.schemastore.porters.projectExporters.xmi.XMIModel, Document)
	 */
	public Element renderExtensionXML(org.mitre.schemastore.porters.projectExporters.xmi.XMIModel model, Document doc) {
		...
		int eaid = org.mitre.schemastore.porters.projectExporters.xmi.XMIModel.getEA_LOCALID();
