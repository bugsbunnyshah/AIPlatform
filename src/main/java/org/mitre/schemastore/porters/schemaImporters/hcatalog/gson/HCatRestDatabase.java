...
public class HCatRestDatabase extends HiveDataType {
    ...
    private transient List<org.mitre.schemastore.porters.schemaImporters.hcatalog.gson.HCatRestTable> tableSchema;
    ...
    public List<org.mitre.schemastore.porters.schemaImporters.hcatalog.gson.HCatRestTable> getTableSchemas() throws HCatalogRequestException, HCatalogParseException {
        if (tableSchema == null) {
            tableSchema = new ArrayList<org.mitre.schemastore.porters.schemaImporters.hcatalog.gson.HCatRestTable>();
