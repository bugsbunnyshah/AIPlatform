...
public class SQLWriter {
	...
	protected org.mitre.schemastore.porters.schemaExporters.sql.Rdb _rdb;
	...
	public SQLWriter(org.mitre.schemastore.porters.schemaExporters.sql.Rdb rdb) {
		_rdb = rdb;
	...
	public StringBuffer serialize() throws IOException {
		ArrayList<org.mitre.schemastore.porters.schemaExporters.sql.Table> relations = _rdb.getRelations();
		ArrayList<ForeignKey> foriegnKeys = _rdb.getForeignKeys();
		ArrayList<org.mitre.schemastore.porters.schemaExporters.sql.View> views = _rdb.getViews();
		...
		// serialize tables
		Iterator<org.mitre.schemastore.porters.schemaExporters.sql.Table> relItr = relations.iterator();
		org.mitre.schemastore.porters.schemaExporters.sql.Table rel;
		while (relItr.hasNext()) {
			rel = (org.mitre.schemastore.porters.schemaExporters.sql.Table) relItr.next();
		...
		// views
		Iterator<org.mitre.schemastore.porters.schemaExporters.sql.View> viewItr = views.iterator();
		org.mitre.schemastore.porters.schemaExporters.sql.View view;
		while (viewItr.hasNext()) {
			view = (org.mitre.schemastore.porters.schemaExporters.sql.View) viewItr.next();
	...
	private String createComment(org.mitre.schemastore.porters.schemaExporters.sql.Table rel) {
	...
	public String dropTable(org.mitre.schemastore.porters.schemaExporters.sql.Table rel) {
		return "DROP TABLE " + rel.getName() + " CASCADE; \n ";
	}

	public String dropView(org.mitre.schemastore.porters.schemaExporters.sql.View view) {
	...
	public StringBuffer createTable(org.mitre.schemastore.porters.schemaExporters.sql.Table rel) {
	...
	protected StringBuffer definePrimaryKeys(org.mitre.schemastore.porters.schemaExporters.sql.Table rel) {
	...
	public StringBuffer createView(View view) {
		...
		ArrayList<org.mitre.schemastore.porters.schemaExporters.sql.Table> unionTables = view.getUnionRelations();
		String viewName;
		for (int i = 0; i < unionTables.size(); i++) {
			org.mitre.schemastore.porters.schemaExporters.sql.Table table = (Table) unionTables.get(i);
			if (table == null) {
