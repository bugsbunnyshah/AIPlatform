...
public class XMIModel extends XMIModelElement {
	...
	public static XMIModel generateSimple() { 
		...
		for(int x=0; x<links.length; x++) { 
			org.mitre.schemastore.porters.projectExporters.xmi.XMILink l = new org.mitre.schemastore.porters.projectExporters.xmi.XMILink(links[x][0], links[x][1], "Good Match");
