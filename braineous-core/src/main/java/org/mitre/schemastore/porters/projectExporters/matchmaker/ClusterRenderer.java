...
public class ClusterRenderer {
	...
	private ArrayList<org.mitre.schemastore.porters.projectExporters.matchmaker.Synset> synsets;
	...
	public ClusterRenderer(ArrayList<org.mitre.schemastore.porters.projectExporters.matchmaker.Synset> synsets, SchemaStoreClient schemaStoreClient, Integer[] schemaIDs ) {
	...
	public void print(File output) throws IOException {
		...
		ArrayList<org.mitre.schemastore.porters.projectExporters.matchmaker.SynsetTerm> nodes;
