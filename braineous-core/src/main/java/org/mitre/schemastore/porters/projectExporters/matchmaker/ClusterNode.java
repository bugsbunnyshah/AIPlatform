...
public class ClusterNode {
	public ArrayList<org.mitre.schemastore.porters.projectExporters.matchmaker.Synset> synsets;
	...
	public ClusterNode(ArrayList<org.mitre.schemastore.porters.projectExporters.matchmaker.SynsetTerm> nodes) {
		synsets = new ArrayList<org.mitre.schemastore.porters.projectExporters.matchmaker.Synset>();
		for (org.mitre.schemastore.porters.projectExporters.matchmaker.SynsetTerm n : nodes) {
			synsets.add(new org.mitre.schemastore.porters.projectExporters.matchmaker.Synset(n));
		}
	}
	 ...
	 */
	public ArrayList<org.mitre.schemastore.porters.projectExporters.matchmaker.SynsetTerm> getGroup(int j) {
	...
	public void cluster(int schemaCount, int maxElements) {
		...
		ArrayList<org.mitre.schemastore.porters.projectExporters.matchmaker.Synset> completedClusters = new ArrayList<org.mitre.schemastore.porters.projectExporters.matchmaker.Synset>();
		...
		while (1 == 1) {
			...
			for (i = 0; i < synsets.size(); i++) {
				org.mitre.schemastore.porters.projectExporters.matchmaker.Synset n1 = synsets.get(i);

				for (j = i + 1; j < synsets.size(); j++) {
					org.mitre.schemastore.porters.projectExporters.matchmaker.Synset n2 = synsets.get(j);
...
//				if (notInSameSchema(synsets.get(spot1), synsets.get(spot2))){
					org.mitre.schemastore.porters.projectExporters.matchmaker.Synset growing = synsets.get(spot1);
...
//				} else System.err.println("(E)Found groupes in same schema: " + synsets.get(spot1).leastNode.elementName + " \n\t " + synsets.get(spot2).leastNode.elementName);
	...
	public void removeCluster(int idx) {
		...
		org.mitre.schemastore.porters.projectExporters.matchmaker.Synset swap = synsets.get(lastIdx);
	 ...
	 * @return
	 */
	private boolean notInSameSchema(org.mitre.schemastore.porters.projectExporters.matchmaker.Synset groupE1, org.mitre.schemastore.porters.projectExporters.matchmaker.Synset groupE2) {
		for (org.mitre.schemastore.porters.projectExporters.matchmaker.Node n1 : groupE1.getGroup()) {
			if (!(n1 instanceof org.mitre.schemastore.porters.projectExporters.matchmaker.SynsetTerm)) continue;
			for (Node n2 : groupE2.getGroup()) {
				if (!(n2 instanceof org.mitre.schemastore.porters.projectExporters.matchmaker.SynsetTerm)) continue;
				if (((org.mitre.schemastore.porters.projectExporters.matchmaker.SynsetTerm) n1).schemaId.equals(((org.mitre.schemastore.porters.projectExporters.matchmaker.SynsetTerm) n2).schemaId)) return false;
			}
		}
		return true;
	}
	 ...
	 * 
	 */
	class groupEScoreComparator implements Comparator<org.mitre.schemastore.porters.projectExporters.matchmaker.Synset> {
		groupEScoreComparator() {}

		public int compare(org.mitre.schemastore.porters.projectExporters.matchmaker.Synset g1, org.mitre.schemastore.porters.projectExporters.matchmaker.Synset g2) {
			return -(getAverageScore(g1).compareTo(getAverageScore(g2)));
		}

		private Double getAverageScore(org.mitre.schemastore.porters.projectExporters.matchmaker.Synset g) {
			Double score = 0.0;
			int numNodes = 0;
			for (org.mitre.schemastore.porters.projectExporters.matchmaker.SynsetTerm node : g.getGroup()) {
	 ...
	 * 
	 */
	public class groupEComparator implements Comparator<org.mitre.schemastore.porters.projectExporters.matchmaker.Synset> {
		Integer baseSchema;
		...
		public int compare(org.mitre.schemastore.porters.projectExporters.matchmaker.Synset g1, Synset g2) {

			org.mitre.schemastore.porters.projectExporters.matchmaker.SynsetTerm n1 = g1.getTerm(baseSchema);
