...
public class ForeignKey extends RdbAttribute
{
    ...
    public ForeignKey(Rdb schema, org.mitre.schemastore.porters.schemaExporters.sql.Table fromTable, String fromAtt,
                      org.mitre.schemastore.porters.schemaExporters.sql.Table toTable, String toAtt, RdbValueType type)  {
