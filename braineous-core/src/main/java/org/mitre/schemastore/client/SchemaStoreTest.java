...
//			Repository repository = new Repository(Repository.DERBY,new File(".").toURI(),"testStore","postgres","postgres");
			org.mitre.schemastore.client.Repository repository = new org.mitre.schemastore.client.Repository(Repository.POSTGRES,new URI("localhost"),"supplies","postgres","postgres");
