...
{	
	...
	private HashMap<String, org.mitre.schemastore.model.terms.Terms> invertedList = new HashMap<String, org.mitre.schemastore.model.terms.Terms>();

	/** Constructs the terms */
	public InvertedTermsByKeyword() {}	
	
	/** Constructs the terms */
	public InvertedTermsByKeyword(org.mitre.schemastore.model.terms.Terms terms)
	...
	private ArrayList<String> generateKeywords(org.mitre.schemastore.model.terms.Term term)
	{
	...
	public void addTerm(org.mitre.schemastore.model.terms.Term term)
	{
		...
		for(String keyword : generateKeywords(term))
		{
			...
			org.mitre.schemastore.model.terms.Terms terms = invertedList.get(keyword);
			if(terms==null) invertedList.put(keyword, terms=new org.mitre.schemastore.model.terms.Terms());
			terms.addTerm(term);
	...
	public void addTerms(org.mitre.schemastore.model.terms.Terms terms)
		{ for(org.mitre.schemastore.model.terms.Term term : terms.getTerms()) addTerm(term); }
	...
	public void removeTerm(org.mitre.schemastore.model.terms.Term term)
	{
		// Cycle through each keyword
		for(String keyword : generateKeywords(term))
		{
