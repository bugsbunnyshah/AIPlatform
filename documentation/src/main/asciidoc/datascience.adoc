...
////
= Braineous, AI Platform - Data Science
...
* Designing and Developing a Data Science App
...
== Designing and Developing a DataScience App
...
== Data Science Support Explained

Braineous provides and end-to-end pipeline for developing, training, and deploying AI models.
It mitigates the slighly expensive DevOps process all the while supporting Docker and Kubernetes containers.
These containers can then be easily deployed to public clouds like Azure, Amazon, and Google Cloud.
It also facilitates a reverse deployment process where a live model can be deactivated, and re-trained using historical and new datasets.

== What's next?

This guide covered the creation of a Data Science Application using Braineous.
link:retraining.html[Retrain a Live Model].
